...
function run_config ()
{
  ...
  r_pck_int=0.02 #Packet interval time in seconds for responders
...
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 10 55 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 20 105 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 30 180 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 40 225 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 50 279 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 60 333 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 70 395 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 80 448 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 90 507 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 10 0 100 100 563 >> $main_log_file 2>&1 &

run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 10 55 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 100 20 105 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 30 180 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 40 225 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 50 279 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 60 333 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 70 395 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 80 448 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 90 507 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 30 0 100 100 563 >> $main_log_file 2>&1 &

run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 10 55 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 20 105 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 30 180 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 40 225 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 50 279 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 60 333 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 70 395 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 80 448 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 90 507 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 70 0 100 100 563 >> $main_log_file 2>&1 &

run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 10 55 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 20 105 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 30 180 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 40 225 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 50 279 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 60 333 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 70 395 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 80 448 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 90 507 >> $main_log_file 2>&1 &
run_config $SIMULATION_TIME $PERIOD_LENGTH $MCS $PSSCH_SUBCHANNEL_RBS $KTRP $PACKET_PAYLOAD_SIZE $PSCCH_RB_M $PSCCH_SF_BITMAPS $MIN_UES_PER_SECTOR 90 0 100 100 563 >> $main_log_file 2>&1 &
